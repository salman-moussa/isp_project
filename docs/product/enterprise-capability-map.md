...
AR/AP/treasury remain unfinished. Procurement/receiving/valuation, telemetry, RADIUS execution and
mobile hardware acceptance are separate unfinished work.
...
| Warehouse and procurement            | Items/SKUs, serialized assets, vendors, quotes, POs, receiving, warehouses/bins, transfers, reservations, issue/return, RMA, reorder, valuation                                       | `partial`                         | Custody, vendors, valued POs, MFA approval, catalog/warehouse/bin administration, bin-level bulk stock, partial mixed receiving with part-value posting, transfers, MFA-gated valued adjustments, reservations, expensed material consumption, controlled stock counts, the RMA/repair lifecycle with write-off posting, reorder suggestions, and vendor quote requests with award-to-order are live; weighted-average costing and supplier-claim workflows on rejected goods remain. |
...
| AAA and access control               | RADIUS clients/NAS, PPPoE/Hotspot/DHCP identity, auth policy, simultaneous use, profiles/rate limits, accounting start/interim/stop, CoA/disconnect, session history                  | `partial`                         | NAS registry, worker-only accounting ingest and session history are live; redundant RADIUS service and acknowledged CoA/disconnect remain `activation_required` against the real NAS.                                                                                                                                                                                                                                                                                                 |
| IPAM and network configuration       | IPv4/IPv6 pools, prefixes, VLANs, addressing, reservations, DNS records, CGNAT/public IP, configuration templates, change plans, approvals, rollback                                  | `partial`                         | Pools, reservations, next-free allocation, router/binding registry and the worker job queue are live and conflict-safe; VLAN/prefix planning, DNS and rollback-capable change plans remain.                                                                                                                                                                                                                                                                                           |
| CPE lifecycle                        | Model/firmware inventory, provisioning, configuration, Wi-Fi, diagnostics, signal/optical levels, reboot/reset, firmware rollout, TR-069/USP adapter                                  | `foundation`                      | CPE registry with service/asset links is live; provisioning, diagnostics and firmware need a TR-069/USP adapter and ACS activation.                                                                                                                                                                                                                                                                                                                                                   |
| NOC and service assurance            | Discovery, topology, polling/streaming telemetry, alarms, dedup/correlation, maintenance, outages, impacted services, escalation, status timeline, RCA/problem/change                 | `partial`                         | Worker-outcome alarms, operator alarms, maintenance suppression, incident SLA and scoped incident/impact/RCA are proven locally; device polling, topology, cross-device correlation and communications remain.                                                                                                                                                                                                                                                                        |
| Capacity and upstream management     | Ogero/upstream circuits, transit/peering, committed/burst capacity, utilization, cost, SLA, renewals, guarantees, upgrade forecasts, POP/sector/OLT saturation                        | `partial`                         | Upstream circuit register with committed/burst capacity, cost per currency, contract and renewal notice, append-only utilisation samples, derived utilisation, headroom, saturation rating, linear forecast and renewals due are proven locally; automatic counters, POP/sector/OLT saturation and provider upgrade orders remain.                                                                                                                                                    |
...
| Revenue assurance and fraud          | Billed-vs-active, usage-vs-rating, payment allocation, duplicate/gap detection, unauthorized services, dealer/collector exposure, case management, closure                            | `partial`                         | Eight controls, persistent findings and exposure cases with closure evidence are proven locally; scheduling, usage-vs-rating and unauthorized-service detection remain.                                                                                                                                                                                                                                                                                                               |
| Payments and cash channels           | Office/collector cash, card/POS, bank, domiciliation, transfer, OMT, Whish, LibanPost/Cash United adapters, proof, settlement, chargeback/refund, reconciliation                      | `partial` / `activation_required` | Office cashier (drawers, atomic receipts with allocations, voids as linked reversals, method and reference) is proven locally; each provider channel still needs its adapter, contract and settlement acceptance.                                                                                                                                                                                                                                                                     |
| Dealer/reseller and vouchers         | Dealer hierarchy, POS users, commission, credit limit, stock, PIN/voucher batches, activation, redemption, settlement, fraud controls                                                 | `partial`                         | Registry, per-currency float, PIN batches, issue/cancel, guarded redemption and subscriber credit are proven locally; hierarchy, POS users, settlement statements and fraud analytics remain.                                                                                                                                                                                                                                                                                         |
| Collections                          | Route planning, assignment, offline payment, receipt, printer, cash handover, discrepancy approval, revocation recovery                                                               | `partial` / `activation_required` | Route collectors, balance-derived assignments, office-recorded cash, settlements with approved differences and device visibility are proven locally; production collector account, OTP, approved printer and end-of-day acceptance remain.                                                                                                                                                                                                                                            |
| Customer service and complaints      | Omnichannel intake, caller verification, subscriber/service context, ticket/SLA, complaint classification, escalation, outage link, redress, reopen, knowledge, satisfaction          | `partial`                         | Verified intake, SLA, notes, escalation, incident link, governed status, reopen and redress are proven locally; omnichannel adapters, knowledge base and satisfaction remain.                                                                                                                                                                                                                                                                                                         |
| Communications                       | Approved SMS/email/WhatsApp/provider templates, Arabic/English preference, billing/reminder/outage notifications, consent, delivery receipts, retries, audit                          | `partial`                         | Governed templates, consent, outbox with rendering, suppression, retry and delivery evidence are live; provider credentials, a scheduled worker and event-driven triggers remain.                                                                                                                                                                                                                                                                                                     |
...
| Regulatory and QoS                   | Licence/renewal register, obligations, tariffs, coverage/expansion, KPI definitions, sampling, availability, faults/MTTR, complaints, periodic submissions, evidence retention        | `partial`                         | Licences, obligations, KPI definitions, computed evidence with retained numerators and denominators, and submissions with decisions are proven locally; regulator portals, tariff and coverage registers and active sampling remain.                                                                                                                                                                                                                                                  |
| Management analytics                 | Executive, sales, churn, AR/aging, revenue, cash, network health, SLA, capacity, workforce, inventory dashboards; scheduled and exported reports                                      | `partial`                         | Live dashboard and nine governed datasets with recorded CSV export are proven locally; scheduled delivery, trend history and churn/capacity analytics remain.                                                                                                                                                                                                                                                                                                                         |
| People operations                    | Employee record, teams, skills, shifts/on-call, leave/availability, training/certification, goals; payroll only through an approved localized accounting boundary                     | `partial`                         | Employees linked to staff identities, teams, shifts and on-call with conflict rules, separated leave approval and training expiry are proven locally; goals and payroll remain.                                                                                                                                                                                                                                                                                                       |
...
Catalog/warehouse/bin administration, bin-level bulk stock, partial mixed receiving, transfers and
valued adjustments are delivered with local acceptance evidence (2026-09-05). Continue into
RMA/repair and reorder suggestions, then an explicit NAS/RADIUS activation boundary. Inventory
intake and financial valuation must remain atomic with accounting evidence; network actions retain
exact idempotency, canonical scope, action-specific acknowledgement and fail-closed provider
behavior. Telemetry, alarm correlation, SLA and communications remain the next NOC expansion.
Relocation remains coupled to the field/resource delivery tranche.

Production identity activation requires platform SMTP settings saved and tested in Control Center →
Administration → Integrations (product-managed delivery), or an approved external HTTPS provider.
