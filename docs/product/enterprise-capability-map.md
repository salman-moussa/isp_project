...
| Warehouse and procurement            | Items/SKUs, serialized assets, vendors, quotes, POs, receiving, warehouses/bins, transfers, reservations, issue/return, RMA, reorder, valuation                                       | `partial`                         | Custody, vendors, valued POs, MFA approval, complete serialized receipt and Inventory/AP posting are live; administration, quote comparison, partial/non-serialized receipts, reservation, bins and transfers remain. |
...
Continue from locally proven custody and serialized procurement into catalog/warehouse
administration, partial and non-serialized receipts, bins, transfers and reservations, then an
explicit NAS/RADIUS activation boundary. Inventory intake and financial valuation must remain atomic
with accounting evidence; network actions retain exact idempotency, canonical scope, action-specific
