...
| Warehouse and procurement            | Items/SKUs, serialized assets, vendors, quotes, POs, receiving, warehouses/bins, transfers, reservations, issue/return, RMA, reorder, valuation                                       | `partial`                         | Custody, vendors, valued POs, MFA approval, catalog/warehouse/bin administration, bin-level bulk stock, partial mixed receiving with part-value posting, transfers, MFA-gated valued adjustments, reservations, expensed material consumption, controlled stock counts, the RMA/repair lifecycle with write-off posting, and reorder suggestions are live; vendor quote comparison and backorder/damaged-quantity handling remain. |
