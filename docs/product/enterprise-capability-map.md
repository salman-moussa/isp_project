...
| NOC and service assurance            | Discovery, topology, polling/streaming telemetry, alarms, dedup/correlation, maintenance, outages, impacted services, escalation, status timeline, RCA/problem/change                 | `partial`                         | Manual scoped incident/impact/RCA is proven locally; next connect real alarms, SLA, communications and maintenance.                                                                                                                                                                                                                                                                                                                                                                   |
