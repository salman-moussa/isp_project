...
| `apps/collector-mobile`              | Assigned field collection, encrypted offline outbox, printing and reconciliation.                         | Encrypted device snapshots/drafts; server remains canonical. | Device-local.                                                         |
