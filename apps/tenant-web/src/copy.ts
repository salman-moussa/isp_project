...
const english: TenantCopy = {
  ...
  navigation: [
    ...
    { id: 'capacity', label: 'Capacity & upstream' },
    { id: 'warehouse', label: 'Warehouse & custody' },
    { id: 'installations', label: 'Installations' },
    { id: 'support', label: 'Customer service' },
    { id: 'communications', label: 'Communications' },
    { id: 'reports', label: 'Reports' },
    { id: 'regulatory', label: 'Regulatory & QoS' },
    { id: 'people', label: 'People & shifts' },
...
const arabic: TenantCopy = {
  ...
  navigation: [
    ...
    { id: 'capacity', label: 'السعة والروابط العلوية' },
    ...
    { id: 'regulatory', label: 'التنظيم وجودة الخدمة' },
    { id: 'people', label: 'الفريق والمناوبات' },
    { id: 'staff', label: 'الحسابات والصلاحيات' },
